...
figure~\ref{fig:ch4-classes-schema} (§~\ref{sec:ch4-modelisation}).
	...
	\begin{figure}[H]
		...
		\IfFileExists{public/raspberry.jpg}{%
			...
			\fbox{\textit{Figure manquante~: \texttt{public/raspberry.jpg}}}
		}
	...
	\begin{figure}[H]
		...
		\IfFileExists{public/arduino.jpg}{%
			...
			\fbox{\textit{Figure manquante~: \texttt{public/arduino.jpg}}}
		}
	...
	\begin{figure}[H]
		...
		\IfFileExists{public/l293d.jpg}{%
			...
			\fbox{\textit{Figure manquante~: \texttt{public/l293d.jpg}}}
		}
	...
	\begin{figure}[H]
		...
		\IfFileExists{public/moteur.jpg}{%
			...
			\fbox{\textit{Figure manquante~: \texttt{public/moteur.jpg}}}
		}
	...
	\begin{figure}[H]
		...
		\IfFileExists{public/servo.jpg}{%
			...
			\fbox{\textit{Figure manquante~: \texttt{public/servo.jpg}}}
		}
	...
	\begin{figure}[H]
		...
		\IfFileExists{public/mic.jpg}{%
			...
			\fbox{\textit{Figure manquante~: \texttt{public/mic.jpg}}}
		}
	...
	\begin{figure}[H]
		...
		\IfFileExists{public/pam8403.jpg}{%
			...
			\fbox{\textit{Figure manquante~: \texttt{public/pam8403.jpg}}}
		}
	...
	\begin{figure}[H]
		...
		\IfFileExists{public/hauteparleurs.jpg}{%
			...
			\fbox{\textit{Figure manquante~: \texttt{public/hauteparleurs.jpg}}}
		}
	...
	\begin{figure}[H]
		...
		\IfFileExists{public/camera.jpg}{%
			...
			\fbox{\textit{Figure manquante~: \texttt{public/camera.jpg}}}
		}
	...
	\begin{figure}[H]
		...
		\IfFileExists{public/ecran.jpg}{%
			...
			\fbox{\textit{Figure manquante~: \texttt{public/ecran.jpg}}}
		}
	...
	\begin{figure}[H]
		...
		\IfFileExists{public/powerbank.jpg}{%
			...
			\fbox{\textit{Figure manquante~: \texttt{public/powerbank.jpg}}}
		}
	...
	\begin{figure}[H]
		...
		\IfFileExists{public/piles.jpg}{%
			...
			\fbox{\textit{Figure manquante~: \texttt{public/piles.jpg}}}
		}
...
\end{lstlisting}
	...
	\IfFileExists{public/koda-cycle4-logical-architecture.png}{%
		...
		\begin{center}
			\fbox{\begin{minipage}{0.88\textwidth}\centering\vspace{1em}
				\textit{Exporter \texttt{plantuml/koda-cycle4-logical-architecture.puml}
				vers \texttt{public/koda-cycle4-logical-architecture.png}.}
	...
	\IfFileExists{public/koda-cycle4-code-architecture.png}{%
		...
		\begin{center}
			\fbox{\begin{minipage}{0.88\textwidth}\centering\vspace{1em}
				\textit{Exporter \texttt{plantuml/koda-cycle4-code-architecture.puml}
				vers \texttt{public/koda-cycle4-code-architecture.png}.}
				\vspace{1em}\end{minipage}}
		\end{center}
	}
...
\end{lstlisting}
	...
	question. Si l'endpoint général échoue, le service revient vers
	...
	\begin{table}[H]
		...
		\label{tab:ch5-tests}
		\renewcommand{\arraystretch}{1.25}
		\begin{tabularx}{\textwidth}{|p{3.3cm}|X|p{3.2cm}|}
			\hline
			\textbf{Type de test} & \textbf{Procédure} & \textbf{Critère OK} \\
			\hline
