...
\begin{document}
	...
	\begin{itemize}
		...
		\item \textbf{Chapitre~II} expose la préparation du projet : spécification des besoins, identification des acteurs, méthodologie de pilotage \textit{cylindrique} par cycles, planification, architecture cible et environnements de travail.
...
Le chapitre suivant, \textbf{«\,Préparation du Projet\,»}, formalise les besoins, la méthodologie de développement par cycles successifs et les environnements techniques retenus pour mener à bien la réalisation de KODA.
	...
	présentons également la \textbf{méthodologie de pilotage} retenue : une approche
	\textit{cylindrique} fondée sur des \textbf{cycles de développement successifs} —
	et non sur une succession de sprints Scrum — chaque cycle livrant une couche ou un
	sous-système intégrable dans l'ensemble. Enfin, nous documentons les environnements
	matériel et logiciel qui ont encadré la production du prototype.
	...
	\begin{itemize}
		...
		des écrans mobiles sans remettre en cause l'ensemble du cylindre logiciel.
	\end{itemize}
	...
	%----------------------------------------------------------------
	\section{Pilotage du projet — Méthodologie cylindrique par cycles}
	%----------------------------------------------------------------
	...
	retenu une approche \textbf{cylindrique} : le produit est vu comme un empilement de
	couches cohérentes (interface, logique, persistance, embarqué, services externes) que
	l'on enrichit par \textbf{cycles successifs}, chaque cycle produisant un incrément
	\textbf{testable} et \textbf{branchable} sur les cycles précédents. La métaphore du
	\textit{cylindre} souligne que chaque cycle «\,enrobe\,» ou complète le noyau
	existant — workflow, puis services, puis matériel, puis logiciel embarqué, puis
	client mobile, puis validation — jusqu'à former un système complet.
	...
	structure la cadence réelle ; la méthodologie cylindrique en garantit la
	...
	fonctionnels, acteurs, architecture de référence, environnements, et surtout une
	\textbf{méthodologie cylindrique} articulée en six cycles — en rupture avec une
